...
<div id="gamipress-achievements-list" class="achievements-php gamipress-achievements-list">
  ...
  <div id="gamipress-achievements-filters-wrap">
    ...
    if ($a['filter'] === 'no'): ?>
      ...
      <input type="hidden" name="achievements_list_filter" id="achievements_list_filter"
        value="<?php echo esc_attr($a['filter_value']); ?>">
      ...
      <div id="gamipress-achievements-filter">
        ...
        <select name="achievements_list_filter" id="achievements_list_filter">
          ...
          <?php // Loop all filter options
            ...
            <option value="<?php echo esc_attr($value); ?>" <?php selected($a['filter_value'], $value); ?>>
    ...
    if ($a['search'] === 'yes'):
      ...
      <div id="gamipress-achievements-search">
        ...
        <form id="gamipress-achievements-search-form" action="" method="post">
          ...
          <input type="text" id="gamipress-achievements-search-input" name="achievements_list_search"
            value="<?php echo esc_attr($search); ?>">
          <input type="submit" id="gamipress-achievements-search-submit" name="achievements_list_search_go"
  ...
  <div id="gamipress-achievements-container"
    class="gamipress-achievements-container gamipress-columns-<?php echo esc_attr($a['columns']); ?> gamipress-columns-small-<?php echo esc_attr($a['columns_small']); ?>">
    <?php echo $a['query']['achievements']; ?>
  </div>

  <?php // Hidden fields ?>
  <input type="hidden" id="gamipress-achievements-offset" value="<?php echo esc_attr($a['query']['offset']); ?>">
  <input type="hidden" id="gamipress-achievements-count"
    value="<?php echo esc_attr($a['query']['achievement_count']); ?>">
