...
<div class="points-php <?php echo esc_attr(implode(' ', $classes)); ?>">
  <?php
  /**
    ...
    <div class="gamipress-points gamipress-user-points-<?php echo esc_attr($points_type); ?>">
      ...
      <div class="gamipress-user-points-description">
        ...
        <?php // User Points Label (before)
          ...
          <span
            class="gamipress-user-points-label"><?php echo gamipress_get_points_amount_label($amount, $points_type); ?></span>
